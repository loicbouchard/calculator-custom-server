...
router.get('/shop/:shopId/search-combination', function(req, res, next) {
  ...
  var lowestValue = possibleCombinations[0].value;
  var greatestValue = possibleCombinations[possibleCombinations.length - 1].value;
  if (desiredAmount < lowestValue) desiredAmount = lowestValue;
  if (desiredAmount > greatestValue) desiredAmount = greatestValue;
